...
public class SideMirror extends ActionBarActivity {
...
public void on(View v)
{
    ...
    {
        try {
            Toast.makeText(getBaseContext(), "ton sent", Toast.LENGTH_SHORT).show();
            //String msg="smf";
            String msg="ton";
    ...
    public void off(View v)
    {
        ...
        {
            try {
                Toast.makeText(getBaseContext(), "tof sent", Toast.LENGTH_SHORT).show();
                //String msg="smu";
                String msg="tof";
                mmOutputStream.write(msg.getBytes());
